...
public class GrindstoneCommand {
    ...
    private static int execute(CommandSourceStack source) {
        ...
        player.openMenu(new SimpleMenuProvider((syncId, inventory, playerEntity) -> new GrindstoneMenu(syncId, inventory, ContainerLevelAccess.create(player.level(), player.blockPosition())) {
            @Override
