...
public class LoomCommand {
    ...
    private static int execute(CommandSourceStack source) {
        ...
        player.openMenu(new SimpleMenuProvider((syncId, inventory, playerEntity) -> new LoomMenu(syncId, inventory, ContainerLevelAccess.create(player.level(), player.blockPosition())) {
            @Override
